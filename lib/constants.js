...
// Exercices poids de corps — volume = lest uniquement (pas le poids du corps)
export const BW_EXERCISES = [
  'Pompes','Push-Up','Push Up','Traction','Tractions','Pull-Up','Pull Up','Chin-Up','Chin Up',
  'Dips','Dip','Relevé de jambe','Relevé de Jambes','Leg Raise',
  'Crunch','Crunches','Ab Wheel','Roue abdominale',
  'Planche','Plank','Mountain Climber','Burpee','Burpees',
  'Muscle-Up','Muscle Up','L-Sit','Hollow Hold','Superman',
  'Gainage','Pike Push-Up','Handstand Push-Up','Pistol Squat',
]

export function isBW(name) {
  if (!name) return false
  const n = name.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,'')
  return BW_EXERCISES.some(bw => n.includes(bw.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,'')))
}
